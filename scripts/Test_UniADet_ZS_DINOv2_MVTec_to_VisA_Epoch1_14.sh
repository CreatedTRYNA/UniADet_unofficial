...
GPU="${GPU:-cuda:0}"
TEST_DATASET="${TEST_DATASET:-visa}"
TEST_PATH="${TEST_PATH:-/mnt/nvme-data1/pzh_proj/datasets/visa}"
CHECKPOINT_DIR="${CHECKPOINT_DIR:-/mnt/nvme-data1/pzh_proj/my_uniadet/experiments/uniadet_zs_dinov2/mvtec_to_visa/checkpoints}"
