...
For DINOv2/DINOv3 backbones, use `timm>=1.0.24`. A repository-local fallback is provided for DINOv2 ViT-L/14 register checkpoints when older `timm` builds do not register that model.
